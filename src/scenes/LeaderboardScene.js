...
export class LeaderboardScene extends Phaser.Scene {
  ...
  create() {
    ...
    createVSBackButton(this, camera.width - 84, 36, () => {
  ...
  _updateTabStyles() {
    for (const tab of this.tabButtons) {
      ...
      tab.bg.setStrokeStyle(2, active ? 0xc4a040 : 0x4a4a5a, 1);
      tab.text.setColor(active ? "#ffffff" : "#888888");
    }
  }
  ...
  async _loadLeaderboard() {
    ...
    try {
      ...
      const headerBg = this.add.rectangle(0, startY - 10, 480, 28, 0x2a2a4a, 0.9);
      ...
      data.entries.forEach((entry, i) => {
        ...
        const bgColor = i % 2 === 0 ? 0x2a2a4a : 0x323242;
